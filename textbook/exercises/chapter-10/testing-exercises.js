  ...
  "exercises": [
    {
      ...
      "main-function": "int main(void) {\n    char s[1000];        // buffer for input string\n    int counts[26] = {0}; // array to hold letter counts\n\n    printf(\"Enter a sentence: \");\n    fgets(s, sizeof(s), stdin);  // read a line including spaces\n\n    countLetters(s, counts);     // call the student's function\n\n    printf(\"The frequency that each lower case letter appears is:\\n\");\n    for (int i = 0; i < 26; i++) {\n        if (counts[i] > 0) {\n            printf(\"%c: %d\\n\", 'a' + i, counts[i]);\n        }\n    }\n\n    return 0;\n}\n",
      "testcases": [
        {
          "input": [
            "hello, world"
          ...
          "output": [
            "Enter a sentence: The frequency that each lower case letter appears is:\n\nd: 1\ne: 1\nh: 1\nl: 3\no: 2\nr: 1\nw: 1\n"
          ]
        },
        {
          "input": [
      ...
      "testcases": [
        {
          ...
          "output": [
            "Enter string s1: Enter string s2:\n Last occurrence is at position 5\n"
          ]
        },
        {
          "input": [
    ...
    },
    {
      ...
      "main-function": "int main(void) {\n    char str[1000]; // assuming max input length\n    int n;\n\n    // Read input from stdin\n    if (fgets(str, sizeof(str), stdin) == NULL) {\n        return 1;\n    }\n    // Remove trailing newline if present\n    str[strcspn(str, \"\\n\")] = '\\0';\n\n    if (scanf(\"%d\", &n) != 1) {\n        return 1;\n    }\n\n    char *result = preamble(str, n);\n\n    if (result == NULL) {\n        printf(\"NULL\\n\");\n    } else {\n        printf(\"%s\\n\", result);\n        free(result);\n    }\n\n    return 0;\n}\n",
      "testcases": [
        {
          "input": [
            "Toronto\n3"
    ...
    },
    {
      ...
      "main-function": "int main(void) {\n    char source[1000];\n    char substring[1000];\n\n    // Read source and substring from input\n    if (fgets(source, sizeof(source), stdin) == NULL) return 1;\n    if (fgets(substring, sizeof(substring), stdin) == NULL) return 1;\n\n    // Remove trailing newline characters\n    size_t len = 0;\n    len = strlen(source);\n    if (len > 0 && source[len - 1] == '\\n') source[len - 1] = '\\0';\n    len = strlen(substring);\n    if (len > 0 && substring[len - 1] == '\\n') substring[len - 1] = '\\0';\n\n    char *result = deleteSubString(source, substring);\n\n    if (result != NULL) {\n        printf(\"%s\\n\", result);\n        free(result);\n    }\n\n    return 0;\n}\n",
      "testcases": [
        {
          "input": [
            "my toronto\nto"
